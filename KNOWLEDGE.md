...
- Invariant (unit-test this): One quote-store per book. Verdict is reread / not — no stars. progressFraction = currentPage/totalPages.
- Empty: The shelf is empty. Set down your first book — and leave a thought in the margins.
- Fake that fails: Pagetopia islands, or a Goodreads star shelf.
